...
const int Ventilador_PIN = 6; //Pin del ventilador
...
if(humedadTierra < 30 && luminosidad < 30) { //Condicional para encender la bomba
...
if(t > 22){ //Condicional para los ventiladores
