// se puede utilizar la idea de este hombre para poder definir un abecedario y todos los caracteres necesarios para tener un espacio adicional en el lcd (no tengo tiempo para implementar esto).
